...
{
	// Token: 0x0600045A RID: 1114 RVA: 0x00006011 File Offset: 0x00004211
	...
	// Token: 0x0600045B RID: 1115 RVA: 0x0000602C File Offset: 0x0000422C
	...
	// Token: 0x0600045C RID: 1116 RVA: 0x00006047 File Offset: 0x00004247
	...
	// Token: 0x0600045D RID: 1117 RVA: 0x00006054 File Offset: 0x00004254
	...
	// Token: 0x0600045E RID: 1118 RVA: 0x00006061 File Offset: 0x00004261
	...
	// Token: 0x0600045F RID: 1119 RVA: 0x0002A158 File Offset: 0x00028358
	...
	// Token: 0x06000460 RID: 1120 RVA: 0x0002A230 File Offset: 0x00028430
		...
		try
		{
			...
			case 9:
			{
				...
				if ((int)b7 != -1)
				{
					...
					Res.outz("is Monkey = " + b8);
					if (global::Char.myCharz().charID == num19)
					{
						global::Char.myCharz().isMask = true;
						global::Char.myCharz().isMonkey = b8;
					...
					else if (GameScr.findCharInMap(num19) != null)
					{
						GameScr.findCharInMap(num19).isMask = true;
						GameScr.findCharInMap(num19).isMonkey = b8;
					}
					if (num20 != -1)
					{
						if (num19 == global::Char.myCharz().charID)
						{
							global::Char.myCharz().head = (int)num20;
						}
						else if (GameScr.findCharInMap(num19) != null)
						{
							GameScr.findCharInMap(num19).head = (int)num20;
						}
					}
					if (num21 != -1)
					{
						if (num19 == global::Char.myCharz().charID)
						{
							global::Char.myCharz().body = (int)num21;
						}
						else if (GameScr.findCharInMap(num19) != null)
						{
							GameScr.findCharInMap(num19).body = (int)num21;
						}
					}
					if (num22 != -1)
					{
						if (num19 == global::Char.myCharz().charID)
						{
							global::Char.myCharz().leg = (int)num22;
						}
						else if (GameScr.findCharInMap(num19) != null)
						{
							GameScr.findCharInMap(num19).leg = (int)num22;
						}
					}
				}
				if ((int)b7 == -1)
				{
					...
					{
						GameScr.findCharInMap(num19).isMask = false;
						GameScr.findCharInMap(num19).isMonkey = 0;
					}
				}
				break;
			}
				...
				for (int num97 = 0; num97 < num95; num97++)
				{
					...
					for (int num99 = 0; num99 < num98; num99++)
					{
						...
						if (num100 != -1)
						{
							...
							if ((int)b46 == 4)
							{
								global::Char.myCharz().arrItemShop[num97][num99].reason = msg.reader().readUTF();
							}
							else if ((int)b46 == 0)
							{
							...
							{
								global::Char.myCharz().arrItemShop[num97][num99].isBuySpec = true;
								global::Char.myCharz().arrItemShop[num97][num99].iconSpec = msg.reader().readShort();
								global::Char.myCharz().arrItemShop[num97][num99].buySpec = msg.reader().readInt();
							}
							...
							if ((int)b48 == 1)
							{
								...
								global::Char.myCharz().arrItemShop[num97][num99].setPartTemp(headTemp, bodyTemp, legTemp, bagTemp);
							}
						}
					}
				}
			...
			case 58:
			{
				...
				global::Char.myCharz().strLevel = new string[(int)b49];
				for (int num104 = 0; num104 < (int)b49; num104++)
				{
			...
			case 63:
			{
				...
				if ((int)b51 == 2)
				{
					...
					int quantity = global::Char.myCharz().arrItemBag[(int)b52].quantity;
					global::Char.myCharz().arrItemBag[(int)b52].quantity = (int)b53;
					if (global::Char.myCharz().arrItemBag[(int)b52].quantity < quantity && (int)global::Char.myCharz().arrItemBag[(int)b52].template.type == 6)
					{
						GameScr.hpPotion -= quantity - global::Char.myCharz().arrItemBag[(int)b52].quantity;
					}
					if (global::Char.myCharz().arrItemBag[(int)b52].quantity == 0)
					{
						global::Char.myCharz().arrItemBag[(int)b52] = null;
					}
				}
				break;
			}
			case 64:
			{
				...
				if ((int)b54 == 2)
				{
					...
					global::Char.myCharz().arrItemBox[(int)b56].quantity = (int)b57;
					if (global::Char.myCharz().arrItemBox[(int)b56].quantity == 0)
					{
						global::Char.myCharz().arrItemBox[(int)b56] = null;
					}
				}
				break;
			}
			case 65:
			{
				...
				if ((int)b58 == 0 && GameScr.gI().magicTree != null)
				{
					...
					for (int num124 = 0; num124 < (int)b59; num124++)
					{
			...
			case 68:
			{
				...
				for (int num129 = 0; num129 < (int)num128; num129++)
				{
					...
					for (int num130 = 0; num130 < (int)b60; num130++)
					{
			...
			case 95:
			{
				...
				{
					Cout.println("Loi PLAYER_ATTACK_N_P " + ex10.ToString());
				}
			...
			case 110:
			{
				...
				if ((int)b62 != 0)
				{
					Mob.arrMobTemplate[num138].data.readDataNewBoss(NinjaUtil.readByteArray(msg), b62);
				}
				else
				{
			...
			case 123:
				...
				for (int num141 = 0; num141 < global::Char.myCharz().arrItemBox.Length; num141++)
				{
					short num142 = msg.reader().readShort();
					if (num142 != -1)
					{
						global::Char.myCharz().arrItemBox[num141] = new Item();
						global::Char.myCharz().arrItemBox[num141].typeUI = 4;
						global::Char.myCharz().arrItemBox[num141].indexUI = num141;
						global::Char.myCharz().arrItemBox[num141].template = ItemTemplates.get(num142);
						global::Char.myCharz().arrItemBox[num141].isLock = msg.reader().readBool();
						if (global::Char.myCharz().arrItemBox[num141].isTypeBody())
						{
							global::Char.myCharz().arrItemBox[num141].upgrade = (int)msg.reader().readByte();
						}
						global::Char.myCharz().arrItemBox[num141].isExpires = msg.reader().readBool();
						global::Char.myCharz().arrItemBox[num141].quantity = (int)msg.reader().readShort();
					}
				}
				break;
			case 126:
			...
			case -125:
			{
				...
				for (int num147 = 0; num147 < GameScr.vNpc.size(); num147++)
				{
					...
					if (npc2.template.npcTemplateId == num146 && npc2.Equals(global::Char.myCharz().npcFocus))
					{
						...
						for (int num148 = 0; num148 < array10.Length; num148++)
						{
							array10[num148] = msg.reader().readUTF();
						}
				...
				{
					array11[num149] = msg.reader().readUTF();
				}
				try
				{
			...
			case -124:
				...
				{
					Cout.println("Loi OPEN_UI_MENU " + ex12.ToString());
				}
				...
				{
					string[] array12 = global::Char.myCharz().npcFocus.template.menu[num150];
			...
			case -119:
			{
				...
				InfoDlg.hide();
				int num146 = (int)msg.reader().readShort();
				Res.outz("OPEN_UI_SAY ID= " + num146);
				string text6 = msg.reader().readUTF();
				text6 = Res.changeString(text6);
				for (int num151 = 0; num151 < GameScr.vNpc.size(); num151++)
				{
					Npc npc4 = (Npc)GameScr.vNpc.elementAt(num151);
					Res.outz("npc id= " + npc4.template.npcTemplateId);
					if (npc4.template.npcTemplateId == num146)
					{
				...
				Npc npc5 = new Npc(num146, 0, 0, 0, num146, GameScr.info1.charId[global::Char.myCharz().cgender][2]);
			...
			case -117:
			{
				...
				for (int num152 = 0; num152 < array13.Length; num152++)
				{
					...
					GameScr.tasks[num152] = (int)msg.reader().readByte();
					GameScr.mapTasks[num152] = (int)msg.reader().readShort();
					string text10 = msg.reader().readUTF();
					text10 = Res.changeString(text10);
					array15[num152] = -1;
					if (!text9.Equals(string.Empty))
					{
						array13[num152] = text9;
						array14[num152] = text10;
					}
				}
				try
				{
					count = msg.reader().readShort();
					for (int num153 = 0; num153 < array13.Length; num153++)
					{
						array15[num153] = msg.reader().readShort();
					}
				}
				catch (Exception ex14)
				{
					Cout.println("Loi TASK_GET " + ex14.ToString());
				}
			...
			case -107:
			{
				...
				for (int num154 = 0; num154 < (int)b63; num154++)
				{
			...
			case -103:
			{
				...
				int num155 = (int)msg.reader().readUnsignedByte();
				if ((TileMap.tileTypeAtPixel(@char.cx, @char.cy) & 2) == 2)
				{
			...
			case -101:
			{
				...
				if (num137 == global::Char.myCharz().charID)
				{
					...
					if ((int)global::Char.myCharz().cTypePk != 4)
					{
						...
						{
							GameScr.startFlyText("-" + num156, @char.cx, @char.cy - @char.ch, 0, -3, flag6 ? mFont.FATAL : mFont.RED);
						}
					}
				}
				else
				{
					...
					if ((int)@char.cTypePk != 4)
					{
						...
						{
							GameScr.startFlyText("-" + num158, @char.cx, @char.cy - @char.ch, 0, -3, flag7 ? mFont.FATAL : mFont.ORANGE);
						}
					}
				}
				break;
			...
			case -99:
			{
				...
				char9.moveFast[1] = num160;
				char9.moveFast[2] = num161;
				try
				{
					...
					char10.cx = (int)num160;
					char10.cy = (int)num161;
				}
				catch (Exception ex18)
				{
					Cout.println("Loi MOVE_FAST " + ex18.ToString());
				}
				break;
			}
			case -95:
			...
			case -93:
				...
				{
					Cout.println("Loi CLEAR_CUU_SAT " + ex19.ToString());
				}
			...
			case -92:
			{
				...
				if (ItemTime.isExistMessage((int)b66))
				{
					if (num162 != 0)
					{
						ItemTime.getMessageById((int)b66).initTimeText(b66, text11, (int)num162);
					}
					else
					{
				...
				else
				{
					...
					itemTime.initTimeText(b66, text11, (int)num162);
			...
			case -89:
			{
				...
				ItemMap o2 = new ItemMap(num163, num131, itemTemplateID, x, y, r);
			...
			case -69:
			{
				...
				GameCanvas.inputDlg.show(info4, new Command(mResources.ACCEPT, GameCanvas.instance, 88818, num164), TField.INPUT_TYPE_ANY);
				break;
			}
			case -67:
			...
			case -45:
			{
				...
				else if ((int)b68 == 1)
				{
					...
					for (int num165 = 0; num165 < (int)b69; num165++)
					{
						GameCanvas.panel.speacialTabName[num165] = new string[2];
						string[] array17 = Res.split(msg.reader().readUTF(), "\n", 0);
						if (array17.Length == 2)
						{
							GameCanvas.panel.speacialTabName[num165] = array17;
						}
						if (array17.Length == 1)
						{
							GameCanvas.panel.speacialTabName[num165][0] = array17[0];
							GameCanvas.panel.speacialTabName[num165][1] = string.Empty;
						}
						int num166 = (int)msg.reader().readByte();
						global::Char.myCharz().infoSpeacialSkill[num165] = new string[num166];
						global::Char.myCharz().imgSpeacialSkill[num165] = new short[num166];
						for (int num167 = 0; num167 < num166; num167++)
						{
							global::Char.myCharz().imgSpeacialSkill[num165][num167] = msg.reader().readShort();
							global::Char.myCharz().infoSpeacialSkill[num165][num167] = msg.reader().readUTF();
						}
					}
			...
			default:
				...
				case 95:
				{
					...
					global::Char.myCharz().xu += num168;
					GameScr.startFlyText((num168 <= 0) ? (string.Empty + num168) : ("+" + num168), global::Char.myCharz().cx, global::Char.myCharz().cy - global::Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
					break;
				}
				case 96:
				...
				case 97:
				{
					...
					for (int num169 = 0; num169 < global::Char.myCharz().taskOrders.size(); num169++)
					{
						TaskOrder taskOrder = (TaskOrder)global::Char.myCharz().taskOrders.elementAt(num169);
				...
				default:
					...
					default:
							...
							if (command2 != 19)
							{
								if (command2 != 44)
								{
									...
									else
									{
										...
										{
											Cout.println("Loi tai NPC_MISS  " + ex23.ToString());
										}
										if (mob8 != null)
										{
								...
								else
								{
									...
									if (global::Char.myCharz().charID == num170)
									{
										@char = global::Char.myCharz();
									}
									else
									{
										@char = GameScr.findCharInMap(num170);
									}
									if (@char == null)
									{
										return;
						...
						else
						{
							...
							for (int num171 = 0; num171 < (int)b71; num171++)
							{
					...
					case 2:
					{
						...
						for (int num172 = 0; num172 < GameScr.vNpc.size(); num172++)
						{
							Npc npc6 = (Npc)GameScr.vNpc.elementAt(num172);
			...
			case 4:
			{
				...
				int num173 = (int)msg.reader().readUnsignedByte();
				if (num173 > GameScr.vMob.size() - 1 || num173 < 0)
				{
					return;
				}
				Mob mob8 = (Mob)GameScr.vMob.elementAt(num173);
			...
			case 5:
			{
				...
				if (mob8 != null && mob8.status != 0 && mob8.status != 0)
				{
					...
					try
					{
						...
						if (flag8)
						{
							GameScr.startFlyText("-" + num174, mob8.x, mob8.y - mob8.h, 0, -2, mFont.FATAL);
						}
						else
						{
							GameScr.startFlyText("-" + num174, mob8.x, mob8.y - mob8.h, 0, -2, mFont.ORANGE);
						}
						sbyte b74 = msg.reader().readByte();
						for (int num175 = 0; num175 < (int)b74; num175++)
						{
			...
			case 6:
			{
				...
				if (mob8 != null)
				{
					...
					{
						global::Char.myCharz().doInjure(num177, num178, false, true);
					}
					else
					{
						mob8.dame = num177;
			...
			case 8:
			{
				...
				if (mob8 != null)
				{
					...
					if (flag9)
					{
						GameScr.startFlyText("-" + num180, mob8.x, mob8.getY() - mob8.getH(), 0, -2, mFont.FATAL);
					}
					else if (num180 == 0)
					{
						mob8.x = mob8.xFirst;
					...
					{
						GameScr.startFlyText("-" + num180, mob8.x, mob8.getY() - mob8.getH(), 0, -2, mFont.ORANGE);
					}
				}
			...
			case 10:
			{
				...
				for (int num182 = 0; num182 < GameScr.vCharInMap.size(); num182++)
				{
					...
					try
					{
						char13 = (global::Char)GameScr.vCharInMap.elementAt(num182);
					}
					catch (Exception ex32)
					{
						Cout.println("Loi PLAYER_MOVE " + ex32.ToString());
					}
					if (char13 == null)
					{
						break;
			...
			case 11:
			{
				...
				{
					global::Char char14 = (global::Char)GameScr.vCharInMap.elementAt(num183);
					if (char14 != null && char14.charID == num181)
					{
						...
						{
							GameScr.vCharInMap.removeElementAt(num183);
						}
						return;
					}
				}
			...
			case 12:
			{
				...
				if (this.readCharInfo(char15, msg))
				{
					...
					if (num186 != -1)
					{
						...
						if (num186 == 346 || num186 == 347 || num186 == 348)
						{
							char15.isMountVip = false;
						}
						else if (num186 == 349 || num186 == 350 || num186 == 351)
						{
						...
						else if (num186 >= global::Char.ID_NEW_MOUNT)
						{
			...
			case 14:
			{
				...
				if ((int)b78 == 0)
				{
					global::Char.myCharz().cPower += (long)num187;
				}
				if ((int)b78 == 1)
				{
					global::Char.myCharz().cTiemNang += (long)num187;
				}
				if ((int)b78 == 2)
				{
					global::Char.myCharz().cPower += (long)num187;
				...
				{
					GameScr.startFlyText(((num187 <= 0) ? string.Empty : "+") + num187, global::Char.myCharz().cx, global::Char.myCharz().cy - global::Char.myCharz().ch, 0, -4, mFont.GREEN);
					if (num187 > 0 && global::Char.myCharz().petFollow != null && global::Char.myCharz().petFollow.smallID == 5002)
					{
						ServerEffect.addServerEffect(55, global::Char.myCharz().petFollow.cmx, global::Char.myCharz().petFollow.cmy, 1);
						ServerEffect.addServerEffect(55, global::Char.myCharz().cx, global::Char.myCharz().cy, 1);
					}
			...
			case 15:
			{
				...
				GameScr.startFlyText((num188 <= 0) ? (string.Empty + num188) : ("+" + num188), global::Char.myCharz().cx, global::Char.myCharz().cy - global::Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
				break;
			}
			case 16:
			{
				...
				global::Char.myCharz().xu += num189;
				global::Char.myCharz().yen -= num189;
				GameScr.startFlyText("+" + num189, global::Char.myCharz().cx, global::Char.myCharz().cy - global::Char.myCharz().ch - 10, 0, -2, mFont.YELLOW);
				break;
			}
			}
	...
	// Token: 0x06000461 RID: 1121 RVA: 0x0003497C File Offset: 0x00032B7C
	...
	// Token: 0x06000462 RID: 1122 RVA: 0x00034A80 File Offset: 0x00032C80
	...
	// Token: 0x06000463 RID: 1123 RVA: 0x00034EB8 File Offset: 0x000330B8
	...
	// Token: 0x06000464 RID: 1124 RVA: 0x000350EC File Offset: 0x000332EC
	...
	// Token: 0x06000465 RID: 1125 RVA: 0x00035174 File Offset: 0x00033374
	...
	// Token: 0x06000466 RID: 1126 RVA: 0x000351AC File Offset: 0x000333AC
	...
	// Token: 0x06000467 RID: 1127 RVA: 0x000351F0 File Offset: 0x000333F0
	...
	// Token: 0x06000468 RID: 1128 RVA: 0x0003548C File Offset: 0x0003368C
	...
	// Token: 0x06000469 RID: 1129 RVA: 0x00035830 File Offset: 0x00033A30
	...
	// Token: 0x0600046A RID: 1130 RVA: 0x00036824 File Offset: 0x00034A24
	...
	// Token: 0x0600046B RID: 1131 RVA: 0x0003692C File Offset: 0x00034B2C
	public void messageNotMap(Message msg)
	{
		...
		try
		{
			...
			case 10:
				...
				{
					Cout.LogError("LOI TAI CASE REQUEST_MAPTEMPLATE " + ex6.ToString());
				}
				msg.cleanup();
	...
	// Token: 0x0600046C RID: 1132 RVA: 0x0003735C File Offset: 0x0003555C
	...
	// Token: 0x0600046D RID: 1133 RVA: 0x000373F4 File Offset: 0x000355F4
			...
			default:
				...
				case 63:
				{
					...
					if ((int)b6 > 0)
					{
						...
						for (int num17 = 0; num17 < (int)b6; num17++)
						{
							string caption = msg.reader().readUTF();
							string caption2 = msg.reader().readUTF();
	...
	// Token: 0x0600046E RID: 1134 RVA: 0x00038F58 File Offset: 0x00037158
	...
	// Token: 0x0600046F RID: 1135 RVA: 0x00039070 File Offset: 0x00037270
	...
	// Token: 0x06000470 RID: 1136 RVA: 0x000393AC File Offset: 0x000375AC
	...
	// Token: 0x06000471 RID: 1137 RVA: 0x00039414 File Offset: 0x00037614
	...
	// Token: 0x06000472 RID: 1138 RVA: 0x00039448 File Offset: 0x00037648
	...
	// Token: 0x06000473 RID: 1139 RVA: 0x00039784 File Offset: 0x00037984
	...
	// Token: 0x06000474 RID: 1140 RVA: 0x0003982C File Offset: 0x00037A2C
